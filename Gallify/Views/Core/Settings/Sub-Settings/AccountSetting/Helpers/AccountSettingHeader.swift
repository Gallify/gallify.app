...
struct AccountSettingHeader: View {
...
struct AccountSettingHeader_Previews: PreviewProvider {
    static var previews: some View {
        AccountSettingHeader(screenWidth: UIScreen.main.bounds.width, screenHeight: UIScreen.main.bounds.height)
    }
}
