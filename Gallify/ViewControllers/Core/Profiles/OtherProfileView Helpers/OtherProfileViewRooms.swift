...
struct OtherProfileViewRooms: View {
...
struct OtherProfileViewRooms_Previews: PreviewProvider {
    static var previews: some View {
        OtherProfileViewRooms(screenHeight: UIScreen.main.bounds.height, screenWidth: UIScreen.main.bounds.width)
    }
}
