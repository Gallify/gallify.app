...
struct CuratorProgramSettingHeader: View {
...
struct CuratorProgramSettingHeader_Previews: PreviewProvider {
    static var previews: some View {
        CuratorProgramSettingHeader(screenWidth: UIScreen.main.bounds.width, screenHeight: UIScreen.main.bounds.height)
    }
}
